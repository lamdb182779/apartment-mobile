...
export default function ApartmentScreen() {
    ...
    useEffect(() => {
        if (path.startsWith("/owner/apartments")) mutate()
    }, [path])

    const { data, isLoading, mutate } = useSWR(`/apartments/${+number}`, fetcher)
                    ...
                    <View className="flex gap-2">
                        ...
                        <View className="flex flex-row gap-2 justify-between items-center">
                            ...
                            <View className="flex flex-row gap-2">
                                {tenantLooking ?
                                    <Pressable onPress={handleChange} className="bg-red-500 w-8 h-8 flex items-center justify-center rounded-full">
                                        <FontAwesome name="search-minus" size={16} color="white" />
                                    </Pressable>
                                    :
                                    <Pressable onPress={handleChange} className="bg-green-500 w-8 h-8 flex items-center justify-center rounded-full">
                                        <FontAwesome name="search-plus" size={16} color="white" />
                                    </Pressable>

                                }
                                <Pressable className="bg-black w-8 h-8 flex items-center justify-center rounded-full">
